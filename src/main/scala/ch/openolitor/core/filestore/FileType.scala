...
case object VorlageLieferreport extends FileType with VorlageTyp { val bucket = VorlagenBucket }
...
case object GeneriertLieferplanungDetail extends FileType { val bucket = GeneriertBucket }
