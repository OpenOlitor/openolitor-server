      ...
      stammdatenWriteRepository.getAbosByVertrieb(id) map { abo =>
        abo match {
          case dlAbo: DepotlieferungAbo =>
            ...
            stammdatenWriteRepository.updateEntity[DepotlieferungAbo, AboId](copy, depotlieferungAboMapping.column.vertriebBeschrieb)
          case hlAbo: HeimlieferungAbo =>
            ...
            stammdatenWriteRepository.updateEntity[HeimlieferungAbo, AboId](copy, heimlieferungAboMapping.column.vertriebBeschrieb)
          case plAbo: PostlieferungAbo =>
            ...
            stammdatenWriteRepository.updateEntity[PostlieferungAbo, AboId](copy, postlieferungAboMapping.column.vertriebBeschrieb)
        }
      }
    }
  }
  ...
  def updateAbotyp(meta: EventMetadata, id: AbotypId, update: AbotypModify)(implicit personId: PersonId = meta.originator) = {
    DB localTxPostPublish { implicit session => implicit publisher =>
      ...
      stammdatenWriteRepository.getUngeplanteLieferungen(id) map { lieferung =>
        ...
        stammdatenWriteRepository.updateEntity[Lieferung, LieferungId](updatedLieferung, lieferungMapping.column.zielpreis)
      }
    }
  }
