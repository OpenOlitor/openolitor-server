...
class BuchhaltungInsertServiceSpec extends Specification {
  "BuchhaltungInsertService" should {
    ...
    val kontoDaten = KontoDaten(KontoDatenId(123), Some("bank account holder"), Some("address bank account holder"), Some("Bank Name"), Some("CH1223"), Some("777777777"), Some("123456"), Some(KundeId(23)), None, new DateTime, PersonId(123), new DateTime, PersonId(123))
  ...
  "BuchhaltungInsertService" should {
    ...
    val kontoDaten = KontoDaten(KontoDatenId(123), None, None, None, Some("CH1223"), Some("132"), Some(""), None, None, new DateTime, PersonId(123), new DateTime, PersonId(123))
