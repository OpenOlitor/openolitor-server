...
class BuchhaltungInsertServiceSpec extends Specification {
  "BuchhaltungInsertService" should {
    ...
    val kontoDaten = KontoDaten(KontoDatenId(123), Some("CH1223"), None, Some("123456"), Some("777777777"), Some("bank name"), Some("name account holder"), Some("address account holder"), Some(KundeId(23)), None, new DateTime, PersonId(123), new DateTime, PersonId(123))
  ...
  "BuchhaltungInsertService" should {
    ...
    val kontoDaten = KontoDaten(KontoDatenId(123), Some("CH1223"), Some(""), None, Some("132"), Some(""), Some(""), None, None, None, new DateTime, PersonId(123), new DateTime, PersonId(123))
