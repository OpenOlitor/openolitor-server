...
trait WithInMemoryDatabase extends ModifyingSystemConfigReference with BeforeAfterAll with MockDBComponent {
  ...
  override protected def modifyConfig(): Config = {
    ...
    super
      .modifyConfig()
      .withValue("openolitor.test.slick.db.url", url)
      .withValue("openolitor.test.slick.db.driver", driver)
      .withValue("openolitor.test.slick.db.user", user)
      .withValue("openolitor.test.slick.db.password", password)
      .withValue("openolitor.test.jdbc-journal.slick.db.url", url)
      .withValue("openolitor.test.jdbc-journal.slick.db.driver", driver)
      .withValue("openolitor.test.jdbc-journal.slick.db.user", user)
      .withValue("openolitor.test.jdbc-journal.slick.db.password", password)
      .withValue("openolitor.test.jdbc-snapshot-store.slick.db.url", url)
      .withValue("openolitor.test.jdbc-snapshot-store.slick.db.driver", driver)
      .withValue("openolitor.test.jdbc-snapshot-store.slick.db.user", user)
      .withValue("openolitor.test.jdbc-snapshot-store.slick.db.password", password)
      .withValue("openolitor.test.jdbc-read-journal.slick.db.url", url)
      .withValue("openolitor.test.jdbc-read-journal.slick.db.driver", driver)
      .withValue("openolitor.test.jdbc-read-journal.slick.db.user", user)
      .withValue("openolitor.test.jdbc-read-journal.slick.db.password", password)
      .withValue("openolitor.test.db.default.url", url)
      .withValue("openolitor.test.db.default.driver", driver)
      .withValue("openolitor.test.db.default.user", user)
      .withValue("openolitor.test.db.default.password", password)
  }
