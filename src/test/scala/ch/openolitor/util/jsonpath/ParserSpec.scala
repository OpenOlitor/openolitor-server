 ...
 */
class ParserSpec extends Specification with Matchers with ParsingMatchers {

  "Field parsing" should {
    "work with standard names" in {
  ...
  "it" should {
    ...
    "work with some predefined boolean operators" in {
  ...
  "Array parsing" should {
    "work with random array accessors" in {
